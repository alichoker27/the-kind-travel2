...
import styles from "@/styles/EditTrip/editTrip.module.css";
import {
  MdCloudUpload,
  MdDelete,
  MdEdit,
...
export default function EditTripForm({ trip }: EditTripFormProps) {
  ...
  // Form State - Initialized from trip prop
  const [title, setTitle] = useState(trip.title);
  const [tourType, setTourType] = useState(trip.tourType);
  const [includes, setIncludes] = useState(trip.includes);
  const [notes, setNotes] = useState(trip.notes || "");
  const [description, setDescription] = useState(trip.description || "");
  const [places, setPlaces] = useState<string[]>(trip.places);
      ...
      <div className={styles.container}>
        ...
        <header className={styles.header}>
          <div className={styles.headerContent}>
            <MdEdit className={styles.headerIcon} />
        ...
        <form onSubmit={handleSubmit} className={styles.form}>
          ...
          <div className={styles.actionButtons}>
            <Link href="/trips" className={styles.cancelButton}>
